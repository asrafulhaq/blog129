            ...
            <div class="row align-items-center">
                <div class="col-auto profile-image">
                    <a href="#">
                        ...
                        <img class="rounded-circle" alt="User Image" src="admin/assets/img/avatar.jpg">
                        @else 
                ...
                <div class="col ml-md-n2 profile-user-info">
                    ...
                    <div class="user-Location"><i class="fa fa-map-marker"></i> {{ $user_data -> address }}</div>
                    <div class="about-text">{{ $user_data -> bio }}</div>
                    <div class="social">
                        <ul style="list-style:none; width:200px;" class="d-flex flex-row justify-content-between">
                            
                            @if(  $social != NULL AND isset($social -> fb))
                            <li><i class="fa fa-facebook"></i></li>
                            @endif 
                           @if( $social != NULL AND isset($social -> tw))
                            <li><i class="fa fa-twitter"></i></li>
                            @endif
                            @if( $social != NULL AND isset($social -> lin))
                            <li><i class="fa fa-linkedin"></i></li>
                            @endif
                            @if($social != NULL AND isset($social -> insta))
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <p class="col-sm-10">{{ $user_data -> username }}</p>
                                </div>
                                <div class="row">
                                        ...
                                        <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row form-row">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <label>Mobile</label>
                                                        <input name="cell" type="text" value="{{ $user_data -> cell }}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                    <label>Bio</label>
                                                        <textarea class="form-control" name="bio" id="" >{{ $user_data -> bio }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    ...
                                                    <label>Facebook</label>
                                                        <input name="fb" type="text" value="@if( $social != NULL ) {{ $social -> fb }} @endif" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                    <label>Twitter</label>
                                                        <input name="tw" value="@if( $social != NULL ) {{ $social -> tw }} @endif" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                    <label>Linkedin</label>
                                                        <input name="lin" value="@if( $social != NULL ) {{ $social -> lin }} @endif" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                    <label>Instagram</label>
                                                        <input name="insta" value="@if( $social != NULL ) {{ $social -> insta }} @endif" type="text" class="form-control">
                                                    </div>
                                                </div>
